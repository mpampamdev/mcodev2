    ...
    <div class="card m-b-30">
      ...
      <div class="card-body">
          ...
          <div class="form-group">
            <label>Title</label>
            <input type="text" class="form-control form-control-sm" placeholder="Title" name="title" id="title">
          </div>

          <div class="form-group">
            <label>Desc</label>
            <textarea class="form-control text-editor" rows="3" data-original-label="desc" name="desc"></textarea>
            <div id="desc"></div>
          </div>
          ...
          <div class="form-group">
            ...
            --->
            <?=is_select("auth_user","id_user","id_user","name");?>
          </div>
          ...
          <div class="form-group">
            ...
            --->
            <?=is_radio("filemanager","id_image","id","file_name");?>
          </div>
